...
const { verifyJwtForClient, handleAdminCreateAccounts, handleAdminLogin, handleSuperAdminCount, handleSuperAdminCreate, handleCreateContentAdmin, handleReportAdminCreate, getAllDetailReport, uploadSheetAdmin, getMostPopularTemplate, forgetPasswordAdmin } = require('../controllers/admins');
...
router.post("/admin-forget-password", forgetPasswordAdmin);
